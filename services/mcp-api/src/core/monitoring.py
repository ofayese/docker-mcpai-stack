...
request_count = Counter(
    "mcp_api_requests_total", "Total API requests", ["method", "endpoint", "status"]
)
...
active_requests = Gauge(
    "mcp_api_active_requests", "Number of active requests being processed"
)

system_info = Info("mcp_api_system_info", "System information about the MCP API")
